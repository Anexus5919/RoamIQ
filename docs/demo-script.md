...
456 words at **155 words per minute**, written to run continuously. There are
...
- Numbers read aloud, not as digits: "six hundred and sixty nine", "five
  hundred and seventy seven".
- The flight line deliberately does **not** recite the fare. It is large on
  screen at that moment, and reading it out was what made the line sound
  machine-written. Point at it instead.
